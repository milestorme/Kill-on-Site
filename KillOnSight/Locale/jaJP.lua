...
L.SYNC_DISABLED = "同期にはギルドに所属している必要があります。"
L.SYNC_SENT = "同期リクエストを送信。"
L.SYNC_TOO_OLD = "同期失敗：相手のバージョンが古すぎます（oldest=%s、current=%s）。"
L.UI_ADD = "追加"
...
L.UI_NEARBY_RANGE_CLAMP = "検知距離（クラシック風）"
...
L.UI_STEALTH_FLASH = "ステルス検知で画面点滅"
L.UI_SYNC = "今すぐ同期"
...
L.UI_BATTLEGROUNDS = "戦場"
L.UI_BG_MUTE_SOUNDS = "戦場ではすべての通知サウンドをミュート"

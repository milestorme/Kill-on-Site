...
L.ENEMY_NAMEPLATES_REQUIRED = "A detecção passiva nas proximidades requer que as placas de nome inimigas estejam ativadas."
...
L.UI_STEALTH_FLASH = "Piscar a tela ao furtivo"

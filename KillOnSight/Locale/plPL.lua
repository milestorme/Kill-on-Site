...
L.ENEMY_NAMEPLATES_REQUIRED = "Pasywne wykrywanie w pobliżu wymaga włączenia wrogich tabliczek z nazwami."
...
L.SYNC_DISABLED = "Synchronizacja wymaga bycia w gildii."
L.SYNC_SENT = "Wysłano prośbę o synchronizację."
L.SYNC_TOO_OLD = "Synchronizacja nie powiodła się: partner jest zbyt daleko w tyle (oldest=%s, current=%s)."
L.UI_ADD = "Dodaj"
...
L.UI_NEARBY_RANGE_CLAMP = "Zasięg wykrywania (jak w Classic)"
...
L.UI_STEALTH_FLASH = "Błysk ekranu przy skradaniu"
...
L.UI_BATTLEGROUNDS = "Pola bitwy"
L.UI_BG_MUTE_SOUNDS = "Wycisz wszystkie dźwięki powiadomień na polach bitwy"

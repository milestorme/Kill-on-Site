...
L.ENEMY_NAMEPLATES_REQUIRED = "附近被動偵測需要啟用敵方姓名板。"
...
L.SYNC_DISABLED = "同步需要加入公會。"
L.SYNC_SENT = "已送出同步請求。"
L.SYNC_TOO_OLD = "同步失敗：對等方版本過舊（oldest=%s，current=%s）。"
L.UI_ADD = "新增"
L.UI_ADD_GUILD = "新增公會"
L.UI_ADD_KOS = "新增 KoS"
L.UI_CLEAR = "清除"
...
L.UI_NEARBY_RANGE_CLAMP = "偵測範圍（經典風格）"
...
L.UI_BATTLEGROUNDS = "戰場"
L.UI_BG_MUTE_SOUNDS = "在戰場中靜音所有提示音"

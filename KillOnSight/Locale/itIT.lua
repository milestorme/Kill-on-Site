...
L.SYNC_DISABLED = "La sincronizzazione richiede di essere in una gilda."
L.SYNC_SENT = "Richiesta di sincronizzazione inviata."
L.SYNC_TOO_OLD = "Sincronizzazione fallita: il partner è troppo indietro (oldest=%s, current=%s)."
L.UI_ADD = "Aggiungi"
...
L.UI_NEARBY_RANGE_CLAMP = "Raggio di rilevamento (stile Classic)"
...
L.UI_STEALTH_FLASH = "Lampeggio schermo con furtività"
...
L.UI_BATTLEGROUNDS = "Campi di battaglia"
L.UI_BG_MUTE_SOUNDS = "Disattiva tutti i suoni di notifica nei campi di battaglia"

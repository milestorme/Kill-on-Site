...
L.SYNC_DISABLED = "Sync vereist dat je in een gilde zit."
L.SYNC_SENT = "Sync-verzoek verzonden."
L.SYNC_TOO_OLD = "Sync mislukt: de andere partij is te ver achterop (oldest=%s, current=%s)."
L.UI_ADD = "Toevoegen"
...
L.UI_NEARBY_RANGE_CLAMP = "Detectiebereik (Classic-gevoel)"
...
L.UI_STEALTH_FLASH = "Scherm flits bij stealth"
L.UI_SYNC = "Nu syncen"
...
L.UI_BATTLEGROUNDS = "Slagvelden"
L.UI_BG_MUTE_SOUNDS = "Alle meldingsgeluiden dempen in slagvelden"

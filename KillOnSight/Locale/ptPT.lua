...
L.ENEMY_NAMEPLATES_REQUIRED = "A deteção passiva nas proximidades requer que as placas de nome inimigas estejam ativadas."
...
L.SYNC_DISABLED = "A sincronização requer estar numa guild."
L.SYNC_SENT = "Pedido de sincronização enviado."
L.SYNC_TOO_OLD = "Sincronização falhou: o par está muito atrasado (oldest=%s, current=%s)."
L.UI_ADD = "Adicionar"
...
L.UI_NEARBY_RANGE_CLAMP = "Alcance de deteção (estilo Classic)"
...
L.UI_STEALTH_FLASH = "Flash screen on stealth"

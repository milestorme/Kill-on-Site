...
L.SYNC_DISABLED = "Синхронизация требует быть в гильдии."
...
L.UI_CLEAR = "Очистить"
L.UI_CLOSE = "Закрыть"
L.UI_COPY_NAME = "Копировать имя"
L.UI_COPY_NAME_TITLE = "Копировать имя"
L.UI_COPY_NAME_HINT = "Нажмите Ctrl+C, чтобы скопировать"
L.UI_FLASH = "Мигание"
L.UI_GUILD = "Гильдия"
L.UI_FACTION = "Фракция"
